  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center py-6">
        ...
        <Button asChild size="lg" className="border-0 text-white shadow-lg" style={{ background: 'var(--sfp-gold)', color: 'var(--sfp-ink)', borderRadius: '1rem' }}>
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white shadow-sm p-8 md:p-12 text-center" style={{ background: 'var(--sfp-sky)' }}>
      <div className="max-w-lg mx-auto">
        ...
        <Button asChild size="lg" className="border-0 shadow-lg text-white" style={{ background: 'var(--sfp-gold)', color: 'var(--sfp-ink)', borderRadius: '1rem' }}>
          <Link href={categoryHref}>
