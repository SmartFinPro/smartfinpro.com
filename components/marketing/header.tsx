    ...
    <>
      {market === 'us' && (
        <>
          ...
          <Link href="/us/personal-finance/best/credit-card-companies" className={cls} style={{ color: 'var(--sfp-ink)' }} onClick={onClose}><CreditCard className="h-4 w-4" style={{ color: 'var(--sfp-gold)' }} /><span className="text-sm">Compare All Card Issuers</span><span className="text-[10px] px-1.5 py-0.5 rounded-full font-medium" style={{ background: 'rgba(245,166,35,0.15)', color: 'var(--sfp-gold-dark)' }}>New</span></Link>
          <Link href="/us/personal-finance/credit-cards-comparison" className={cls} style={{ color: 'var(--sfp-ink)' }} onClick={onClose}><CreditCard className="h-4 w-4" style={{ color: 'var(--sfp-navy)' }} /><span className="text-sm">Premium Cards: Amex vs Chase</span></Link>
