        ...
        >
          ...
          <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              ...
              className="no-underline inline-flex items-center justify-center h-11 px-6 text-sm font-medium rounded-2xl border-0 shadow-md transition-all duration-200 hover:shadow-lg hover:scale-[1.03] hover:brightness-110 hover:no-underline"
            ...
            <Link
              ...
              className="no-underline hero-secondary-btn inline-flex items-center justify-center h-11 px-6 text-sm font-medium rounded-md border border-white/50 transition-all duration-300 hover:border-white hover:shadow-[0_0_20px_rgba(255,255,255,0.25)] hover:scale-[1.03] hover:no-underline"
