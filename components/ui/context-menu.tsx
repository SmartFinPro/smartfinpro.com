// components/ui/context-menu.tsx — Radix ContextMenu wrapper (pattern: dropdown-menu.tsx)
"use client"
...
function ContextMenuLabel({
  ...
  return (
    <ContextMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn(
        "px-2 py-1.5 text-xs font-semibold text-slate-400 uppercase tracking-wider data-[inset]:pl-8",
        className
      )}
      {...props}
    />
