...
description: "An in-depth analysis of Perimeter 81's Zero Trust features, SASE architecture, and compliance fit for Canadian financial services teams,"
...
sections:
  ...
  - id: testing-results
    title: Zero Trust in Practice for Canadian Finance Teams
  - id: pricing-plans
    title: Pricing Plans
  - id: pros-cons
    title: Pros & Cons
...
<TrustAuthority
  ...
  stats={[
    ...
    { label: "Acquired by Check Point", value: "2023" },
