...
description: "An in-depth analysis of Proofpoint Email Security's threat detection and NCSC Mail Check alignment for UK financial services firms."
...
sections:
  ...
  - id: testing-results
    title: Email Security in Practice for UK Finance Teams
  - id: pricing-plans
    title: Pricing Plans
  - id: pros-cons
    title: Pros & Cons
...
faqs:
  ...
  - question: What is the false positive rate for Proofpoint?
    answer: >-
      Proofpoint's false positive rate is designed to decline over the first
      few months of deployment as its machine learning models calibrate to an
      organisation's specific email patterns, and independent reviewers
      consistently rate its false positive rate as lower than most competing
      solutions.
...
<TrustAuthority
  ...
  stats={[
    ...
    { label: "SE Labs Rating", value: "AAA" },
...
| Incident Response Costs | Average UK breach cost | Risk reduced, not eliminated |
| Compliance Documentation | Manual (£12,000) | Included |
| Security Awareness | Separate (£8,000) | Included |
| **Illustrative 3-Year Total Cost** | **Significantly higher with risk** | **£106,350** |
