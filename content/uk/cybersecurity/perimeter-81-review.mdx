...
description: "An in-depth analysis of Perimeter 81's Zero Trust features, SASE architecture, and FCA/PRA compliance for UK finance teams."
...
sections:
  ...
  - id: testing-results
    title: Zero Trust in Practice for UK Finance Teams
  - id: pricing-plans
    title: Pricing Plans
  - id: pros-cons
    title: Pros & Cons
...
faqs:
  ...
  - question: What happens if Perimeter 81's cloud infrastructure goes down?
    answer: >-
      ...
      failover. Their published SLA targets 99.95% uptime, and configurable
      failover policies are designed to ensure continuous access if one
      region experiences disruption.
...
<TrustAuthority
  ...
  source="SmartFinPro Research · NCSC UK · G2"
  stats={[
