...
<Info>
**Researching individual stocks to trade?** See our [Agnico Eagle Mines (AEM) research note](/research/gold-mining/agnico-eagle-aem) — a worked example of how we cover a single equity (consensus, valuation, catalysts) before routing to a broker. General market information, not personalized advice.
</Info>
