...
<EvidenceCarousel
  title="Platform Interface Evidence"
  source="CrowdStrike Falcon public product documentation · Feb 2026"
  methodNote="Screenshots illustrate the CrowdStrike Falcon console interface based on the platform's public documentation and product materials as of February 2026. Sensitive data (endpoint names, IP addresses, user identities) has been redacted or represents non-production example data."
  slides={[
    {
      ...
      testedOn: "Feb 2026 · CrowdStrike Falcon Pro documentation"
    },
    {
