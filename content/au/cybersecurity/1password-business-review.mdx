...
description: "An in-depth analysis of 1Password Business for Australian finance teams, covering security features, APRA CPS 234 compliance,"
...
sections:
  ...
  - id: testing-results
    title: 1Password Business in Practice for Australian Finance Teams
  - id: pricing-plans
    title: Pricing Plans
  - id: pros-cons
    title: Pros & Cons
...
<TrustAuthority
  ...
  source="SmartFinPro Research · ASD Australia · G2"
  stats={[
