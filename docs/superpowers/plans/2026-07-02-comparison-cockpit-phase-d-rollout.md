...
|---|---|---|---|
| 3 | Trading Platforms (`trading/trading-platforms`) | 9 lt. Shortlist §1; TradingView NICHT als Slot; Merrill Edge neu | 5 aktive Links (Fidelity, Schwab, IBKR, Robinhood, eToro) → Gate-Review, Rest review/visit |
| 4 | Forex Brokers (`forex/forex-brokers`) | Nur 7 echte NFA/CFTC-Broker → 7 Slots + TradingView als redaktioneller Kasten in buyerGuide/methodology (kein Ranking-Slot); FOREX.com-Link „dead" → Gate 5: erst prüfen/reparieren, sonst `review` | IBKR + OANDA aktiv |
| 5 | Credit Repair (`credit-repair/companies`) | Owner §7.2: Safeport Law statt Lexington; Zusatz-Task: Compliance-Hinweis-Block in `content/us/credit-repair/lexington-law-review.mdx` (+ ggf. `best-credit-repair-companies.mdx` prüfen) | The Credit People aktiv |
| 6 | Credit Monitoring (`personal-finance/credit-monitoring`) | Alle 9 neu; IdentityIQ nur mit BBB-Vorsichtsprüfung; PrivacyGuard/IDShield redaktionell | Keine Links → ranked-unmonetarisiert (Daten gut recherchierbar), CTAs `visit` |
| 7 | AI Tools Finance (`ai-tools/ai-tools-finance`) | TradingView hier als vollwertiger Kandidat #5 (Shortlist-Empfehlung); Copy.ai/Jasper/Systeme.io-Reklassifizierung = separater Folgetask, NICHT Teil des Slice | Keine Finance-AI-Links aktiv → überwiegend visit/review |
| 8 | Cybersecurity SMB (`cybersecurity/cybersecurity-smb`) | **Vorstufe im Slice (Owner §7.5):** `perimeter-81-review.mdx` + affiliate_links-Eintrag auf „Check Point SASE (ehem. Perimeter 81)" aktualisieren, Link-Ziel verifizieren; Bitdefender/Sophos/Bitwarden neu | 5–6 aktive Links (CrowdStrike, SentinelOne, 1Password, NordLayer, Perimeter 81, Proofpoint) → Gate-Review |
