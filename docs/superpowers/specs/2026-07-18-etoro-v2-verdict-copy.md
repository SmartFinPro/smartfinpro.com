...
**Status:** Entwurf → Opus-Gate (Runde 1) · **Quellenbasis:** ausschließlich `2026-07-18-etoro-cockpit-audit.md` (Opus-APPROVED, Stand bc0687a) + berechnete Feld-Daten (`position`/`field`: Rang 8/9, Score 8.3, Spread 1.6, Support 7.8 vs. Field-best 9.6).

**Für das Gate markiert:** Drei Aussagen stammen NICHT aus dem T0b-Audit und brauchen unabhängige Verifikation — (a) **TradingView-Integration** (Seed-Attribut, unauditiert), (b) **$100.000-Demo-Konto** (Teil des approbierten deep_dive, aber nie extern geprüft; Quellkandidat https://www.etoro.com/en-us/trading/demo-account/), (c) **SEC-registriert / FINRA/SIPC-Mitglied** (Seed `sipc_insured`, unauditiert; Quellkandidat https://www.etoro.com/en-us/legal/ bzw. FINRA BrokerCheck). Zusätzlich (d) **cons[1] „No futures on US platform"** — vom T0b-Rollover byte-gleich übernommen, Wahrheit nie geprüft. Fällt eine Prüfung durch, fällt die betroffene Zeile ersatzlos.
...
verdict:
  positioning: >-
    ...
    strong for copy trading, weaker where reliable support matters most.
  summary: >-
  ...
  topStrengths:
    - No broker-imposed per-contract fee on US options
    - Copy trading with a permanent $100,000 practice account
    - Native TradingView integration
  mainLimitation: >-
    Customer support scores lowest in the field (7.8/10 against a field best
    of 9.6).
  bestAlternative:
    name: Fidelity
    slug: fidelity-review
    reason: the category leader at 9.6/10, with the field's strongest support score
sectionVerdicts:
  fees: >-
  ...
  platform: >-
    The platform is built around social features and a permanent $100,000
    demo account; TradingView integration covers charting needs most
    social-first brokers leave out.
  safety: >-
    eToro USA is SEC-registered and a FINRA/SIPC member; extended-hours
    availability remains unverified, and we show it as unestablished rather
    than assume it.
  support: >-
    Support is the field's weak spot for eToro — 7.8/10 against a field best
    of 9.6. Weigh this if service quality drives your choice.
finalDecision: >-
  ...
  options without broker contract fees. Within this field it is a mid-tier
  all-rounder, not a category leader — seven platforms score higher overall,
  and its support rating is the group's weakest. Choose eToro if social
...
essentialFacts:
  ...
  - label: Practice account
    ...
    context: Included with every account
    asOf: '2026-07-18'
  ...
  - label: Regulation
    ...
    asOf: '2026-07-18'
    sourceHref: https://www.etoro.com/en-us/legal/
alternatives:
  - slug: fidelity-review
    name: Fidelity
    whyInstead: >-
  ...
  - slug: webull-review
    name: Webull
    whyInstead: >-
      Also charges no broker fee on US equity options, and adds free advanced
...
updateLog:
  - date: '2026-07-18'
    changes:
      ...
      - Fabricated testing claims and reviewer personas removed
```
