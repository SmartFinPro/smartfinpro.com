...
CREATE TABLE IF NOT EXISTS affiliate_links (
  ...
  category VARCHAR(50) CHECK (category IN ('ai-tools', 'cybersecurity', 'trading', 'forex', 'personal-finance', 'business-banking', 'credit-repair', 'credit-score', 'gold-investing', 'debt-relief')),
