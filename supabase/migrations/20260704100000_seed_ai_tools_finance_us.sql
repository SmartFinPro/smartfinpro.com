...
(
  ...
  ARRAY['Strongest editorial consensus','AI transaction categorization + assistant','Widest platform support']::text[],
  ARRAY['Strongest multi-source editorial consensus of any candidate -- Forbes Advisor 4.8, NerdWallet and Engadget''s "Mint successor" consensus','AI Assistant lets you ask natural-language questions about your own linked accounts, not just view static categorization','Cleanest regulatory record in the field -- no enforcement actions or data breaches found']::text[],
