...
(
  ...
  ARRAY['Zero commission','85+ currency pairs','Native TradingView + MT4/MT5']::text[],
  ARRAY['Zero-commission pricing on Standard/Prime — all-in cost lives entirely in a tight 1.15-pip average spread','85+ currency pairs — the widest selection among zero-commission, spread-only US brokers in this comparison','Officially compatible with both TradingView and MetaTrader 4/5 on its Standard and Prime accounts','$0 account minimum with a $50,000 Prime tier for spreads as tight as ~0.6 pips']::text[],
  ...
  'tastyfx (the June 2024 rebrand of IG US, same entity and regulatory registration) pairs zero-commission pricing with a 1.15-pip average EUR/USD spread and 85+ currency pairs — the widest selection among the zero-commission, spread-only brokers in this comparison (Interactive Brokers offers more pairs overall, but only on a commission-based model). It is officially compatible with both TradingView and MetaTrader 4/5 on its Standard and Prime accounts, though its separate commission-based Zero+ tier trades that TradingView support away for a tighter spread. A $50,000 Prime account unlocks spreads as tight as ~0.6 pips for high-volume clients.',
