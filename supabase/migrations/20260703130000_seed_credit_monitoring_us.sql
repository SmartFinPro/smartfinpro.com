...
(
  NULL,
  'identityforce', 'us', 'personal-finance', 'credit-monitoring', 'IdentityForce', 'Highest individual-plan insurance coverage in the field',
  7.8, 3.5, 904, 0, 0, 0, 34.90,
  '{"free_tier":"none","bureaus_monitored":3,"monitoring_scope_note":"Dark-web scanning (independently rated best-in-field by CNBC), SSN monitoring, court/address-record monitoring, and social-media monitoring, backed by a dedicated restoration specialist.","id_theft_insurance":2000000,"id_theft_insurance_note":"Up to $2,000,000 on UltraSecure+Credit (the seeded plan, and the highest individual-plan figure in this entire comparison), Lloyd''s-underwritten with no deductible. The no-credit-monitoring UltraSecure tier carries $1,000,000, not $2,000,000.","family_plan":true,"family_plan_note":"UltraSecure+Credit Family is $39.90/month, covering 2 adults plus up to 10 children.","bbb_rating":"NR","bbb_rating_note":"BBB profile explicitly states IdentityForce is \"NOT a BBB Accredited Business\" and is currently Not Rated while the bureau reviews prior complaints; some third-party aggregators show a higher grade, but this could not be independently confirmed against the BBB profile itself.","bbb_accredited":false,"review_score":3.5,"review_count":904,"review_source":"Trustpilot","review_note":"The weakest Trustpilot score in the ranked field, driven by billing and customer-service complaints; app-store ratings are similarly weak (iOS 3.0, Android 2.5). Some aggregators round this to a higher \"4-star\" display band -- we seed the more precise, directly-verified 3.5 figure rather than the rounded bucket.","score_model":"vantagescore","regulatory_history_note":"No enforcement action against the IdentityForce product itself. Its parent, TransUnion (acquired Sontiq/IdentityForce for $638 million in 2021), carries its own history: a January 2017 CFPB consent order ($13.9 million restitution + $3 million penalty for deceptive marketing of credit-score and subscription products), and an April 2022 CFPB lawsuit alleging violations of that 2017 order -- dismissed with prejudice on February 28, 2025 (no re-filing possible, no payment made, no admission of wrongdoing). Attributed here to the parent company, not the IdentityForce product itself; the BBB''s own current rating reason explicitly ties the Not-Rated status to \"reviewing complaints,\" the same parent-company context."}'::jsonb,
  'official', 'medium',
  '[]'::jsonb,
  ...
  false, null, 'https://www.identityforce.com/', false, 'Highest individual-plan insurance', 6,
