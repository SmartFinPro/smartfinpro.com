...
(
  ...
  '{"options_fee":0.08,"options_fee_note":"Round-trip of the combined $0.04/contract regulatory/clearing pass-through fee (in effect since January 10, 2025; Robinhood no longer charges $0/contract on options).","fractional_shares":true,"fractional_shares_note":"Fractional shares from $1.","crypto_trading":true,"crypto_note":"Robinhood Crypto — own crypto division with a broad coin lineup.","futures_trading":true,"paper_trading":false,"extended_hours":"overnight","extended_hours_note":"\"24 Hour Market\" — 900+ stocks/ETFs, Sunday 8:00pm to Friday 8:00pm ET.","tradingview_integration":false,"cash_sweep_apy":0.01,"cash_sweep_note":"0.01% with no subscription (uninvested cash sits as an unpaid free-credit balance); 3.35% APY only with the $5/month Robinhood Gold subscription.","sipc_insured":true}'::jsonb,
  'official', 'high',
...
(
  ...
  ARRAY['$0/contract on equity options ($0.50/contract on certain index options)','StockBrokers.com "#1 Paper Trading 2026" — high-fidelity, unlimited simulation','Official, integrated TradingView broker — trade directly from TradingView charts','50+ free charting indicators and free Level II quotes for all users']::text[],
