...
function Section({
  ...
  return (
    <section id={id} className="scroll-mt-24">
      <h2 className="text-2xl font-bold mb-6 flex items-center gap-3" style={{ color: 'var(--sfp-ink)' }}>
        <span className="h-px flex-1" style={{ background: 'var(--sfp-navy)', opacity: 0.2 }} />
        <span>{title}</span>
        <span className="h-px flex-1" style={{ background: 'var(--sfp-navy)', opacity: 0.2 }} />
      </h2>
      ...
      <section className="pb-24">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            {/* ------------------------------------------------------ */}
            <nav
              className="rounded-2xl border border-gray-200 bg-white shadow-sm p-6 md:p-8 mb-12"
            >
              <h2 className="text-sm font-semibold uppercase tracking-wider mb-4" style={{ color: 'var(--sfp-ink)' }}>
                Quick Navigation
              </h2>
            ...
            {/* Main content area */}
            <div
              className="rounded-2xl border border-gray-200 bg-white shadow-sm p-8 md:p-12 space-y-16"
            >
              {/* ================================================== */}
                ...
                <DisclosureCard title="About SmartFinPro" icon="🏢">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4 pt-4 border-t border-gray-200">
                    ...
                    <div>
                      ...
                      <p style={{ color: 'var(--sfp-ink)' }}>United States, United Kingdom, Canada, Australia</p>
                    </div>
                  </div>
                </DisclosureCard>
              ...
              <Section id="regulatory-disclosures" title="Regulatory Disclosures by Region">
                ...
                <RegionBlock id="us-regulatory" flag="🇺🇸" region="United States">
                  <DisclosureCard title="FTC Affiliate Disclosure" icon="📋">
                    ...
                    <div
                      className="rounded-lg border border-amber-200 p-4 mt-2"
                ...
                <RegionBlock id="uk-regulatory" flag="🇬🇧" region="United Kingdom">
                  <DisclosureCard title="FCA Regulatory Notice" icon="🏛️">
                    ...
                    <div
                      className="rounded-lg border border-amber-200 p-4 mt-3"
                      style={{ background: '#FEF5E7' }}
                    >
                      <p className="text-xs" style={{ color: 'var(--sfp-ink)' }}>
