...
<div class="rp">
  ...
  // Status 200 (not 401): Cloudways nginx intercepts 401 responses with
  // its own error_page handler, causing an internal redirect loop.
  // The login page is self-contained HTML — 200 is safe here.
