...
export const caMortgageBrokersConfig: TopicConfig = {
  ...
  compareRows: [
    ...
    { key: 'licenses', label: 'Provinces licensed', accessor: (p) => attrArr(p, 'provincial_licenses').join(', ') || '—', score: (p) => attrArr(p, 'provincial_licenses').length },
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'Every business-model detail, licensing reference and rating on this page was verified against official sources on 11 July 2026. Mortgage rates change frequently — get a live, dated quote directly from the platform before relying on any historical rate figure.',
    },
  ],
  compliance: {
    notice:
