...
export const tradingPlatformsConfig: TopicConfig = {
  ...
  buyerGuide: [
    ...
    {
      h3: 'Minimum deposit',
      body: 'Most US brokers have no minimum to open an account. eToro is the one exception in this list, requiring a $50 minimum first deposit for US customers (wire transfers start at $500), where most peers require $0.',
    },
    {
