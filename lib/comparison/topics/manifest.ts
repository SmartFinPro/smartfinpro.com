...
export const BEST_X_MANIFEST: BestXManifestEntry[] = [
  ...
  { market: 'uk', category: 'remortgaging', topic: 'remortgage-brokers', label: 'Best Remortgage Brokers', blurb: 'Whole-of-market remortgage brokers, by lender panel & fees.', icon: 'Building', image: '/images/content/au/personal-finance/athena-home-loans-review.webp' },
