...
export const BEST_X_MANIFEST: BestXManifestEntry[] = [
  ...
  { market: 'us', category: 'business-banking', topic: 'business-bank-accounts', label: 'Best Business Bank Accounts', blurb: 'Fee-free business checking for startups & SMBs.', icon: 'Building', image: '/images/comparison/business-bank-accounts.webp', legacy: true },
